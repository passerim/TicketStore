    ...
    <div class="row mt-5">
        <div class="col-12 col-md-6 offset-md-3">
            ...
            <section id="schermata_di_registrazione">
                <form id="inputform" method="POST" action="processa-organizzatore.php" onsubmit="return validateForm()" enctype="multipart/form-data">
                    <fieldset class="mt-2" id="registrazione">
                        <legend class="text-center">Registrazione Organizzatore</legend>
                        <div class="card card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="descrizione" class="form-control" id="descrizione" maxlength="300" placeholder="Inserisci Descrizione" required></textarea>
                            </div>
                        </div>
                    </fieldset>
